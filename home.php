<?php
/**
 * The blog home template for CloudHost Pro theme
 *
 * This template is used for the blog posts page when using a static front page
 *
                    ...
                    <div class="no-posts-found bg-white rounded-lg shadow-md p-8 text-center">
                        <div class="max-w-md mx-auto">
                            ...
                            <p class="text-gray-600 mb-6">
                                <?php esc_html_e('No blog posts have been published yet. Check back later for updates!', 'cloudhost-pro'); ?>
                            </p>
                        </div>
                    </div>
                        ...
                        <ul class="space-y-3">
                            ...
                            ?>
                                <li class="text-gray-600 text-sm">
                                    <?php esc_html_e('No recent posts available.', 'cloudhost-pro'); ?>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </div>
